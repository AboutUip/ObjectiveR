...
本仓库默认适用 **MIT License**（见仓库根目录 [`LICENSE`](../LICENSE)）。

解释器 **BlinkEngine**、文档与随附脚本在同一许可下发布，除非个别文件另有头注释说明。
...
- 规范正文位于 [`docs/obr/`](obr/README.md)；实现说明位于 [`docs/blink/`](blink/README.md)。
- 若存在 AI 辅助生成或自动生成的片段，仍以仓库内审阅后的版本为准。
