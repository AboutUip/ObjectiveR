...
| `project/ProjectLocator.java` | [modules.md](modules.md) |
| `project/ProjectResolution.java` | [supporting.md](supporting.md)、[modules.md](modules.md) |
| `lex/Lexer.java` | [lexing.md](lexing.md) |
...
| `semantic/SemanticBinder.java` | [semantic-binding.md](semantic-binding.md) |
